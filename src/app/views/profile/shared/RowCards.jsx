                ...
                <Grid container alignItems="center">
                    <Grid item md={5} xs={7}>
                        <Box display="flex" alignItems="center">
                            ...
                            <ProjectName>Task {id}</ProjectName>
                        </Box>
                    </Grid>
                    ...
                    <Hidden smDown>
                        <Grid item xs={3}>
                            ...
                            >
                                <StyledAvatar src="/assets/images/Task1.jpg" />
                                <StyledAvatar src="/assets/images/Task2.jpg" />
                                <StyledAvatar src="/assets/images/Task3.jpg" />
