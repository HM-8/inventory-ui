            ...
            <Grid item xs={12} md={6}>
                <Card elevation={3} sx={{ p: 2 }}>
                    <ContentBox>
                        ...
                        <H3 textcolor={'#08ad6c'}>My Promotion Status</H3>
                    </ContentBox>
                    <ContentBox sx={{ pt: 2 }}>
                        <H1>0</H1>
                        ...
                        <Span textcolor={'#08ad6c'}>(in 1 yr)</Span>
                    </ContentBox>
                </Card>
            </Grid>
            <Grid item xs={12} md={6}>
                <Card elevation={3} sx={{ p: 2 }}>
                    <ContentBox>
                        ...
                        <H3 textcolor={textError}>My Transfer Status</H3>
                    </ContentBox>
                    <ContentBox sx={{ pt: 2 }}>
                        <H1>0</H1>
                        ...
                        <Span textcolor={textError}>(in 1 yr)</Span>
                    </ContentBox>
                </Card>
            </Grid>
        </Grid>
